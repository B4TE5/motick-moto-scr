"""
================================================================================
                    SCRAPERS MODULE CORREGIDO - WALLAPOP MOTOS SCRAPER                    
================================================================================

Modulo de scrapers especificos para cada modelo de moto CORREGIDO
Exporta todos los scrapers disponibles con mejoras implementadas
...
CORRECCIONES:
- Base scraper con selectores actualizados
- Implementacion del boton "Cargar mas"
- Extraccion de datos mejorada
- Navegacion profunda por paginas

================================================================================
"""

# Importar scraper base corregido
from .base_scraper import BaseScraper

# Importar todos los scrapers especificos CORREGIDOS
...
# Funciones de ejecucion directa
...
# Mapeo de modelos a funciones de ejecucion
SCRAPER_FUNCTIONS = {
...
def get_scraper_class(modelo_key: str):
    """
    Obtener clase de scraper para un modelo especifico
...
def get_scraper_function(modelo_key: str):
    """
    Obtener funcion de ejecucion para un modelo especifico
    
    Args:
        modelo_key: Clave del modelo (ej: 'cb125r')
        
    Returns:
        Funcion de ejecucion correspondiente
...
def create_scraper(modelo_key: str):
    """
    Crear instancia de scraper para un modelo especifico
...
def run_scraper(modelo_key: str):
    """
    Ejecutar scraper para un modelo especifico
...
if __name__ == "__main__":
    # Ejecutar validacion si se importa directamente
    validate_scrapers()
